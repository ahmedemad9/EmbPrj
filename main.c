...
int main() {
	...
	float oldlon;
	float distance=0;
	char y[70]="$GPRMC,220516,A,5133.82,N,00042.2542,W,173.8,231.8,130694,004.2,W*70";			//i made an edit here
	//ahmed edited the following section
	char x[70]="$GPRMC,220516,A,5133.82,N,00042.2642,W,173.8,231.8,130694,004.2,W*70";			//i made an edit here
